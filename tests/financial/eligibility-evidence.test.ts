...
describe("M5 raw eligibility evidence", () => {
  ...
  it("requires market authority and rejects mixed daily authority", () => {
    expect(() => quantitative("LIQUIDITY", { marketMetricsAuthorityId: undefined, marketMetricsAuthorityFingerprint: undefined, marketMetricsDerivationFingerprint: undefined })).toThrow("M5_RAW_MARKET_AUTHORITY_REQUIRED");
