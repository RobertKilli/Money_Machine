...
const lineage = { sourceLineageId: "lineage-1", providerId: "provider", datasetId: "market", datasetVersion: "v1", observedAt: aggregate.authority.observedAt, effectiveAvailableAt: aggregate.authority.effectiveAvailableAt, sourceArtifactIds: ["artifact"], fingerprint: sha } as never;
const assertion = createProviderAssetIdentityAssertion({ providerId: "provider", datasetId: "market", datasetVersion: "v1", providerSourceNamespace: "fixture:market", providerAssetId: "asset-1", sourceArtifactId: "artifact", sourceEnvelopeId: "envelope", parserVersion: "parser/v1", envelopeSchemaVersion: "schema/v1", identityType: "EVM_CONTRACT_ADDRESS", identityNamespace: "eip155:1", identityValue: `0x${"1".repeat(40)}`, sourcePayloadFingerprint: sha, recordedAt: asOf });
